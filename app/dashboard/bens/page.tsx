    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Administração de Bens</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold">{totalBens}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <p className="text-sm text-gray-600 mb-1">Emprestados</p>
            <p className="text-3xl font-bold text-orange-600">
              {emprestados}
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <p className="text-sm text-gray-600 mb-1">Quebrados</p>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-500 mb-4">Nenhum bem encontrado</p>
            {isAdmin && (
              <Link href="/dashboard/bens/novo">
